...
acf(kingstimeseriesforecasts$residuals, lag.max=20, plot=FALSE)
...
# Your description is not very clear. Did you try to fit ARIMA model? With this description I can suggest 2 options:
# Try 'decompose' function on time series data in R. Try both additive and multiplicative time series decompositions (period of seasonality should be 12). The residual can be modeled as an ARMA process
# Use exponential smoothing if the previous method failed. It is a nonparametric method and works well with specific datasets (like sales of automobile spares). It may work for your dataset 
