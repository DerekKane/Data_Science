## A 'solution' to Gapminder assignment (emulate Gapminder in two
## hours or less!) using base R graphics.

## See bryan-a01-10-baseGraphicsStepByStep.R for a step-by-step
...
source(paste0(whereAmI,
              "code/bryan-a01-11-baseGraphicsPlotGapminderOneYear.R"))

## test the function
plotGapminderOneYear(1952, gDat, continentColors)
plotGapminderOneYear(2002, gDat, continentColors)
