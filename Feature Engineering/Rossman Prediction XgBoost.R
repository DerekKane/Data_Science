###############################################################
# XGBoost for Sales Prediction at Rossman Stores
###############################################################
...
train <- read_csv("C:/Users/Derek/Documents/R Scripts/Feature Engineering/Rossman Store Sales/train.csv")
test  <- read_csv("C:/Users/Derek/Documents/R Scripts/Feature Engineering/Rossman Store Sales/test.csv")
store <- read_csv("C:/Users/Derek/Documents/R Scripts/Feature Engineering/Rossman Store Sales/store.csv")



# Merge the Store dataset with the train/test set
